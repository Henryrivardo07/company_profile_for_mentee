...
const TrustedBy = () => {
  return (
    <div className="mt-6.5 md:mt-20" aria-labelledby="trusted-by-heading">
      <h3 className="text-center text-md-semibold md:text-xl-semibold text-neutral-25">
...
const CompaniesMarquee = () => {
  return (
    <div className="custom-container relative h-28.5 items-center md:h-50">
